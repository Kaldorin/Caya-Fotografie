...
$empfaenger = "michaelw.mw32@gmail.com";  // Bitte tragen Sie hier Ihre E-Mail Adresse ein. (zwischen den Anführungszeichen)

$ihrname = "Sebastian Nagel";  // Bitte tragen Sie hier Ihren Namen ein. (zwischen den Anführungszeichen) Dieser erscheint als Absender in der Danke Mail.
...
$cfg['Badwordfields'] = 'anrede, titel, vorname, name, firma, telefon, email, betreff, nachricht';  //   Die Namen der Felder, die bei dem Badword-Check geprüft werden sollen - Groß- und Kleinschreibung beachten!
